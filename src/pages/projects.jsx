...
const Project = () => {
    return (
        <>
            ...
            <p className="text-center">Here are few works I've worked on recently</p>
            <div className="flex justify-center gap-10 flex-wrap my-5 mx-5">
                <div className="bg-[#181a27] shadow-2xl shadow-black w-90 p-2">
                    ...
                    <p className='text-center'>I've created a blogging app where the user can add and delete post and cn also upload image</p>
