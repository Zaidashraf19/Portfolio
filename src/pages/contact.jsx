  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 p-5 w-full">
        <div className="rounded-lg shadow shadow-white border-[#181a27] p-5 min-w-1/3">
          <h4 className="text-2xl font-bold text-center uppercase">
            Contact Information
          </h4>

          {/* EMAIL */}
          <div className="flex flex-wrap my-6 p-3 gap-5">
            <span className="border rounded-full p-5 text-[20px] bg-[#1b1e2f]">
              <HiOutlineMail />
            </span>
            <span>
              Email <br />
              ...
              >
                <p className="para">muhammadzaidmuhammadashraf@gmail.com</p>
              </a>
            </span>
          </div>

          {/* CONTACT NUMBER */}
          <div className="flex flex-wrap my-6 text-xl p-3 gap-5">
            <span className="border rounded-full p-5 text-[20px] bg-[#1b1e2f]">
              <HiOutlinePhone />
            </span>
            <span>
        ...
        {/* FORM */}
        <div className="rounded-lg shadow shadow-white border-[#181a27] p-5 min-w-1/2">
...
//                 className="cursor-pointer text-sm md:text-base font-semibold"
//               >
//                 muhammadzaidmuhammadashraf@gmail.com
//               </a>
//             </span>
//           </div>
